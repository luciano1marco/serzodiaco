...
if( in_array($_SERVER['HTTP_HOST'], array('127.0.0.1','localhost')) ) {
	...
	$mainDbDatabase = "proc8719_bd_clinica";
	$mainDbDriver = "mysqli";
}
...
//POSTGRESQL
//R::setup("pgsql:host={$mainDbHost};dbname={$mainDbDatabase}", $mainDbUser, $mainDbPassword);
