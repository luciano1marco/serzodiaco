		...
		<div class="row">
			<div class="col-md-12">
					...
					<div class="box-header with-border">
						<h3 class="box-title"><?php echo anchor('admin/users/create', '<i class="fa fa-plus"></i> '. lang('users_create_user'), array('class' => 'btn btn-block btn-danger btn-flat')); ?></h3>
					</div>
					<div class="box-body">
						<table id="datatable" class="table table-striped table-hover">
							...
							<?php foreach ($users as $user):?>
								<tr>
									...
									<!-- Opções -->                                            
									<td>
									<?php echo anchor($anchor.'/edit/'.$user->id, "<button class=\"btn btn-danger\"><i class=\"fa fa-pencil\"></i> </button>"); ?>
									<span>&nbsp;</span>
									<?php echo anchor($anchor.'/profile/'.$user->id, "<button class=\"btn btn-danger\"><i class=\"fa fa-search\"></i></button>"); ?>                                   
									</td>
								</tr>
							<?php endforeach;?>	
