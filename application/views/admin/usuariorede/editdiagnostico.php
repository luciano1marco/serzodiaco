            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php echo "Editar Diagnostico" ?></h3>
                    </div>
                    <div class="box-body">
                        <?php echo $message; ?>
                        ...
                        <?php echo form_fieldset('Dados'); ?>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="reintegracao">Possibilidade de
                                        Reintegração</label>
                                    <div class="col-sm-8">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-danger" id="btExcluirdiagnostico">Excluir</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div><!-- /.modal -->